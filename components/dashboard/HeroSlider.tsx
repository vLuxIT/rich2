...
// Replace this with your final desktop hero coin/banner asset later.
...
export default function HeroSlider() {
  ...
  return (
    <>
      {/* Desktop hero: recreated with CSS so it fills the wide desktop banner correctly */}
    {/* Desktop hero */}
<section className="relative hidden h-[320px] overflow-hidden rounded-2xl border border-white/10 bg-[#0B0E14] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] md:block">
  {/* Keep subtle section background effects */}
  <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(255,201,40,0.08),transparent_58%)]" />
  <div className="absolute right-0 top-0 h-full w-[45%] bg-[radial-gradient(circle_at_80%_50%,rgba(255,201,40,0.18),transparent_45%)]" />

  {/* Keep light streaks, but not the big sun behind logo */}
  ...
  <div className="relative z-10 grid h-full grid-cols-[1fr_350px] items-center gap-6 px-9 py-9">
    <div>
      ...
      <Link
        href="/exchange"
        className="mt-7 inline-flex items-center gap-3 rounded-full bg-[#FFC928] px-8 py-3.5 text-sm font-bold text-[#05070B] shadow-[0_12px_30px_rgba(255,201,40,0.18)]"
      >
        Explore Now
        <ArrowRight size={18} />
      </Link>
    ...
    <div className="relative flex h-full items-center justify-center">
      ...
      {/* Mobile hero: keeps your 4 PNG slider images */}
      <section className="relative h-[232px] overflow-hidden rounded-2xl border border-white/10 bg-[#0B0E14] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] md:hidden">
